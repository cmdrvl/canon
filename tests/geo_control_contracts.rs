...
use canon::geo::{
    ...
    CANON_GEO_CROSS_DEAL_VERSION, CANON_GEO_DISCOVERY_REQUEST_VERSION,
    CANON_GEO_E4_GATE_ASSESSMENT_VERSION, CANON_GEO_E4_RESCORE_COMPARISON_VERSION,
    CANON_GEO_ENTITY_PROJECTION_VERSION, CANON_GEO_EVENT_EXPOSURE_VERSION,
...
fn expected_implemented_commands() -> BTreeMap<&'static str, ExpectedGeoCommand> {
    BTreeMap::from([
        ...
        (
            ...
            unsurfaced_command(CANON_GEO_CROSS_DEAL_VERSION, true, false),
        ),
        (
