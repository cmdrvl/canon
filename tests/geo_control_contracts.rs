...
use canon::geo::{
    ...
    CANON_GEO_ADDRESS_QUERY_GRAMMAR_VERSION, CANON_GEO_CAPABILITIES_VERSION,
    ...
    CANON_GEO_MULTISOURCE_REQUEST_VERSION, CANON_GEO_PAD_ADDRESS_SET_VERSION,
    CANON_GEO_PAD_MEMBERSHIP_VERSION, CANON_GEO_POPULATION_EVALUATION_VERSION,
    ...
    CANON_GEO_RESIDUAL_OBDD_VERSION, CANON_GEO_RESOURCE_BUDGET_VERSION,
