...
use canon::geo::{
    ...
    CANON_GEO_CAPABILITIES_VERSION, CANON_GEO_COLLATERAL_LEDGER_SEED_VERSION,
    CANON_GEO_COLLATERAL_LEDGER_VERSION, CANON_GEO_COMPOSITION_PROFILE_VERSION,
    ...
    CANON_GEO_DISCOVERY_REQUEST_VERSION, CANON_GEO_E4_GATE_ASSESSMENT_VERSION,
    CANON_GEO_E4_RESCORE_COMPARISON_VERSION, CANON_GEO_ENTITY_PROJECTION_VERSION,
    CANON_GEO_EVENT_EXPOSURE_VERSION, CANON_GEO_EVIDENCE_COMPILATION_VERSION,
    ...
    CANON_GEO_IMAGE_TILE_PIN_VERSION, CANON_GEO_INSPECTION_VERSION,
    ...
    GeoCommandCapability, GeoCommandSurface, GeoContractCapability, GeoControlEntityLevel,
    GeoControlErrorCode, GeoControlProperty, GeoEgressClass, GeoEvidenceClass,
    GeoGeometryTransformContract, GeoIdentityParticipation, GeoInventorySupportStatus,
    GeoLicenseClass, GeoLocalAcquisitionState, GeoLocalArtifactRef, GeoNativeEntityScope,
    GeoNumericBound, GeoNumericMeasure, GeoQuestion, GeoRegionalInventory,
...
fn expected_implemented_commands() -> BTreeMap<&'static str, ExpectedGeoCommand> {
    BTreeMap::from([
        ...
        (
            ...
            unsurfaced_command(CANON_GEO_EVENT_EXPOSURE_VERSION, true, false),
        ),
        (
